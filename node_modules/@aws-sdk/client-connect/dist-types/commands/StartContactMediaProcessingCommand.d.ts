...
import type { StartContactMediaProcessingRequest, StartContactMediaProcessingResponse } from "../models/models_3";
/**
 * @public
 */
...
declare const StartContactMediaProcessingCommand_base: {
    new (input: StartContactMediaProcessingCommandInput): import("@smithy/smithy-client").CommandImpl<StartContactMediaProcessingCommandInput, StartContactMediaProcessingCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [StartContactMediaProcessingCommandInput]): import("@smithy/smithy-client").CommandImpl<StartContactMediaProcessingCommandInput, StartContactMediaProcessingCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartContactMediaProcessingCommand extends StartContactMediaProcessingCommand_base {
