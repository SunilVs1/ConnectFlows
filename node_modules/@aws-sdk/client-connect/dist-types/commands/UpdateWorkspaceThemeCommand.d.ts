...
declare const UpdateWorkspaceThemeCommand_base: {
    new (input: UpdateWorkspaceThemeCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateWorkspaceThemeCommandInput, UpdateWorkspaceThemeCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateWorkspaceThemeCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateWorkspaceThemeCommandInput, UpdateWorkspaceThemeCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateWorkspaceThemeCommand extends UpdateWorkspaceThemeCommand_base {
