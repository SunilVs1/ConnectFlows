...
declare const BatchDescribeDataTableValueCommand_base: {
    new (input: BatchDescribeDataTableValueCommandInput): import("@smithy/smithy-client").CommandImpl<BatchDescribeDataTableValueCommandInput, BatchDescribeDataTableValueCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: BatchDescribeDataTableValueCommandInput): import("@smithy/smithy-client").CommandImpl<BatchDescribeDataTableValueCommandInput, BatchDescribeDataTableValueCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class BatchDescribeDataTableValueCommand extends BatchDescribeDataTableValueCommand_base {
