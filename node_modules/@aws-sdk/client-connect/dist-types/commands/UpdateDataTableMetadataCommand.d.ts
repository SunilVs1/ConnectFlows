...
declare const UpdateDataTableMetadataCommand_base: {
    new (input: UpdateDataTableMetadataCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateDataTableMetadataCommandInput, UpdateDataTableMetadataCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateDataTableMetadataCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateDataTableMetadataCommandInput, UpdateDataTableMetadataCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateDataTableMetadataCommand extends UpdateDataTableMetadataCommand_base {
