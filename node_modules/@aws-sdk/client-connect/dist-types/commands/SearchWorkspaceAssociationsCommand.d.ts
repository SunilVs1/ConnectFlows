...
declare const SearchWorkspaceAssociationsCommand_base: {
    new (input: SearchWorkspaceAssociationsCommandInput): import("@smithy/smithy-client").CommandImpl<SearchWorkspaceAssociationsCommandInput, SearchWorkspaceAssociationsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: SearchWorkspaceAssociationsCommandInput): import("@smithy/smithy-client").CommandImpl<SearchWorkspaceAssociationsCommandInput, SearchWorkspaceAssociationsCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class SearchWorkspaceAssociationsCommand extends SearchWorkspaceAssociationsCommand_base {
