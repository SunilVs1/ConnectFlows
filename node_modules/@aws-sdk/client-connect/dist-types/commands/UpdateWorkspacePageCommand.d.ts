...
declare const UpdateWorkspacePageCommand_base: {
    new (input: UpdateWorkspacePageCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateWorkspacePageCommandInput, UpdateWorkspacePageCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateWorkspacePageCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateWorkspacePageCommandInput, UpdateWorkspacePageCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateWorkspacePageCommand extends UpdateWorkspacePageCommand_base {
