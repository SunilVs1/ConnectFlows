...
declare const EvaluateDataTableValuesCommand_base: {
    new (input: EvaluateDataTableValuesCommandInput): import("@smithy/smithy-client").CommandImpl<EvaluateDataTableValuesCommandInput, EvaluateDataTableValuesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: EvaluateDataTableValuesCommandInput): import("@smithy/smithy-client").CommandImpl<EvaluateDataTableValuesCommandInput, EvaluateDataTableValuesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class EvaluateDataTableValuesCommand extends EvaluateDataTableValuesCommand_base {
