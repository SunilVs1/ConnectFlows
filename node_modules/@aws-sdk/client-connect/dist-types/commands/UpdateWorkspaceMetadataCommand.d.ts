...
declare const UpdateWorkspaceMetadataCommand_base: {
    new (input: UpdateWorkspaceMetadataCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateWorkspaceMetadataCommandInput, UpdateWorkspaceMetadataCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateWorkspaceMetadataCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateWorkspaceMetadataCommandInput, UpdateWorkspaceMetadataCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateWorkspaceMetadataCommand extends UpdateWorkspaceMetadataCommand_base {
