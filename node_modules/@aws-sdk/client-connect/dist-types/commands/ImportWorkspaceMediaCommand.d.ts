...
declare const ImportWorkspaceMediaCommand_base: {
    new (input: ImportWorkspaceMediaCommandInput): import("@smithy/smithy-client").CommandImpl<ImportWorkspaceMediaCommandInput, ImportWorkspaceMediaCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ImportWorkspaceMediaCommandInput): import("@smithy/smithy-client").CommandImpl<ImportWorkspaceMediaCommandInput, ImportWorkspaceMediaCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ImportWorkspaceMediaCommand extends ImportWorkspaceMediaCommand_base {
